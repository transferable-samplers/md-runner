...
# Configuration
# ============================
SEQ_FILE="sequences/short_sequences.txt"

TOTAL_PER_JOB=3        # <-- N total sequences handled by this slurm task
MAX_CONCURRENT=3        # <-- at most 4 python processes at a time
...
for ((k=0; k<TOTAL_PER_JOB; k++)); do
  ...
  python src/generate_remd.py seq_idx=$IDX seq_filename="$SEQ_FILE" n_states=auto time_ns=5000 paths.scratch_dir=/network/scratch/t/tanc/md-runner-short &
