#!/bin/bash
#SBATCH -J remd_throughput_scaling_4c32g
...
# a smaller allocation (4 CPU / 32GB RAM vs the original 16 CPU / 48GB) to see whether
...
TEST_SCRATCH_ROOT=/network/scratch/t/tanc/md-runner-throughput-test-xl-4c32g
