#!/bin/bash
#SBATCH -J generate_remd_pdbs_8aa_1000K
...
# Configuration
# ============================
# 1000K hot-equilibration ladder: 10 hand-picked 8AA sequences (subset of pdbs_8aa.txt),
...
SEQ_FILE="sequences/pdbs_8aa_1000K.txt"
