#!/bin/bash
#SBATCH -J hot_md_restrained_check_600
...
# Same as run_hot_md_restrained.sh but at 600K -- long partition since main didn't have
# capacity. Lands in the same scratch_dir; get_md_output_dir keys on temperature so this
# writes to its own MAPQTIAT_600_500_2000 subdir alongside the 800K/1200K runs.
