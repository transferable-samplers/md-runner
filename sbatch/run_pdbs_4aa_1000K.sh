#!/bin/bash
#SBATCH -J generate_remd_pdbs_4aa_1000K
...
# Configuration
# ============================
# 1000K hot-equilibration ladder: 10 hand-picked 4AA sequences (subset of pdbs_4aa.txt),
# 310K-1000K, chirality+omega restraints on, n_states from the N_STATES_DICT_EVAL table
# (sized for this hotter ladder, see src/generate_remd.py). See run_pdbs_4aa_scramble.sh for
# the original 300-450K-ladder reference this is adapted from.
SEQ_FILE="sequences/pdbs_4aa_1000K.txt"
PDB_DIR="/network/scratch/t/tanc/md-runner-remd-reference-many-1000K/data"  # flat *.pdb, not data/pdbs/
SCRATCH_DIR="/network/scratch/t/tanc/md-runner-remd-reference-many-1000K"
MIN_TEMP=310
MAX_TEMP=1000
...
SEEDS=(1 2 3)
BLOCKS=(0 1 2)          # ceil(10/4)=3 blocks; block 2 only covers 2 sequences (bounds-guarded below)
N_SEEDS=${#SEEDS[@]}
N_BLOCKS=${#BLOCKS[@]}
...
# ----------------------------
# Launch sequences for this seed
# ----------------------------
